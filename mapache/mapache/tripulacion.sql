...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 13, 2025 at 11:57 PM
...
CREATE TABLE `tripulacion` (
  ...
  `habiilidad/fruta` varchar(1000) NOT NULL,
  `rol en la tripulacion` varchar(1000) NOT NULL
...
INSERT INTO `tripulacion` (`id`, `nombre`, `edad`, `habiilidad/fruta`, `rol en la tripulacion`) VALUES
...
(11, 'monkey d. luffy', '19', 'Luffy se comió involuntariamente la fruta Gomu Gomu, una fruta del diablo de tipo paramecia. Esta le da su cuerpo las propiedades de la goma, lo que le permite estirarse, rebotar, doblarse, retorcerse e inflar cualquier parte de su cuerpo.', 'capitan y siedno el mas fuerte  de su tripulacion'),
(12, 'monkey d. luffy', '19', 'Luffy se comió involuntariamente la fruta Gomu Gomu, una fruta del diablo de tipo paramecia. Esta le da su cuerpo las propiedades de la goma, lo que le permite estirarse, rebotar, doblarse, retorcerse e inflar cualquier parte de su cuerpo.', 'capitan y siedno el mas fuerte  de su tripulacion');
