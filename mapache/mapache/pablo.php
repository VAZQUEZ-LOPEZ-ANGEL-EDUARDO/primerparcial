        ...
        <body>
            ...
            <div class="jumbotron text-center" style="background-color: white;">
               ...
               if($resultado->num_rows >0){
                echo "<table>";
                echo "<tr><th>id</th><th>nombre</th><th>edad</th><th>habiilidad/frut</th><th>rol en la tripulacion</th></tr>";
                while($row = $resultado->fecth_assoc()){
                    echo "<tr><td>" . $row["id"] . "</td><td>" . $row["nombre"] . "</td><td>" . $row["edad"] . "</td><td>" . $row["habiilidad"] . "</td><td>" . $row["rol en la tripulacion"] . "</td><td>";
                }
                echo "</table>";
            } else {
                        ...
                        <table>
                            ...
                            <?php while($fila= $resultado->fetch_assoc()): ?>
                                <tr>
                                    ...
                                    <td><?php echo $fila['habiilidad/fruta']; ?></td>
                                    <td><?php echo $fila['rol en la tripulacion']; ?></td>
